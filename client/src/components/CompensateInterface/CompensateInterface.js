    ...
    <div className="comp__container">
      <section className="comp__gallery">
        ...
        <p className="comp__text">
          ...
          produce a huge amount of carbon emissions. A Carbon offset is a way to
          compensate for your emissions by funding an equivalent C02 saving
          elsewhere.
          <br /> <br />
          Many carbon offsetting projects also provide additional benefits such
          as biodiversity increase, education, jobs, food security, clean
          drinking water and well-being to local communities.
          <br /> <br />
          You can choose to support any of the projects below, and many more, in
          order to balance out your carbon footrpint. These comply with
          Certified Emission Reductions (CERs), Gold Standard CERs, Gold
          Standard Verified Emission Reductions (VERs) or Verified Carbon
          Standard (VCS) certified credits, so you can be confident that they're
          effective and have a real impact!
          <br /> <br />
          Happy browsing! 🌎 🌳
        </p>
        <article className="article__container">
          ...
          <div className="article__info-box">
            ...
            <p className="article__text">
              ...
              electricity is exported to the regional electricty grid system in
              India. It seeks to enable investment in large and small grid
        ...
        <article className="article__container">
          ...
          <div className="article__info-box">
            ...
            <p className="article__text">
              ...
              construction and operation of two wind farms located in Enriquillo
              Region of the Dominican Republic. “Larimar I” has 15 wind turbines
              with a total installed capacity of 49.5 MW; and “Larimar II” has
              14 wind turbines with a total installed capacity of 48.3 MW. The
              total installed capacity of the wind farm is 97.8 MW.
            </p>
            <p className="article__info article__info--green article__info--full-length">
              <span className="span--bold"> Estimated Reductions: </span>{' '}
        ...
        <article className="article__container">
          ...
          <div className="article__info-box">
            ...
            <p className="article__info article__info--full-length">
              <span className="span--bold"> Category:</span> Tech / Clean water
              / Local communities
            </p>
            <div className="article__double-info-box">
              <p className="article__info">
            ...
            <p className="article__text">
              ...
              it safe. This reduces indoor air pollution and protects vulnerable
              forests.
            </p>
            <p className="article__info article__info--green article__info--full-length">
              <span className="span--bold"> Estimated Reductions: </span> 20,550
              tCO2e per year
            </p>
            <a
              className="article__info article__info--cta"
      ...
      <section className="comp__gallery">
        <img className="comp__icon" alt="carbon offset icon" src={offsetIcon} />
        ...
        <article className="article__container">
          ...
          <div className="article__info-box">
            ...
            <p className="article__text">
              ...
              logging, squatting and attempts to implement pastures. The project
              is expected to avoid over 22 million tonnes of carbon dioxide
              equivalent greenhouse gas emissions over a 40 year period. This
              will be achieved by managing the land in the form of a "private
              conservation reserve", through rigorous monitoring and
              enforcement.
            </p>
            <p className="article__info article__info--green article__info--full-length">
              <span className="span--bold"> Estimated Reductions: </span>{' '}
        ...
        <article className="article__container">
          ...
          <div className="article__info-box">
            ...
            <p className="article__text">
              <span className="span"> {'>> '} </span> Coal is overwhelmingly the
              main energy source for rural residents in this region of China.
              The proposed project will enable the rural residents to
              efficiently substitute solar energy for coal used in daily cooking
              and water boiling, avoiding CO2 emission that would be generated
              by fossil fuel consumption. The project has installed 49,000 solar
              cookers for the rural residents.
            </p>
            <p className="article__info article__info--green article__info--full-length">
              <span className="span--bold"> Estimated Reductions: </span>{' '}
